...
local tricks = {
    -- {`KIT_EMOTE_TWIRL_GUN`, "Girar"},
    -- --{`KIT_EMOTE_TWIRL_GUN_DUAL`,"Duas Mãos"},
    -- {`KIT_EMOTE_TWIRL_GUN_VAR_A`,"Alternados"},
    -- {`KIT_EMOTE_TWIRL_GUN_VAR_B`,"Sobre o Ombro"},
    -- {`KIT_EMOTE_TWIRL_GUN_VAR_C`,"Lance Infinito"},
    -- {`KIT_EMOTE_TWIRL_GUN_VAR_D`,"Giro Invertido"},

    {`KIT_EMOTE_TWIRL_GUN`, "Girar"},
    --{`KIT_EMOTE_TWIRL_GUN_DUAL`,"Duas Mãos"},
    {`KIT_EMOTE_TWIRL_GUN_VAR_A`,"Giro Lateral"},
    {`KIT_EMOTE_TWIRL_GUN_VAR_B`,"Alternados"},
    {`KIT_EMOTE_TWIRL_GUN_VAR_C`,"Sobre o Ombro"},
    {`KIT_EMOTE_TWIRL_GUN_VAR_D`,"Lance Infinito"},
} 
...
Citizen.CreateThread(function() --
    ...
    while true do
        ...
        if tricking == true and not IsEntityDead(PlayerPedId()) then
            local label  = CreateVarString(10, 'LITERAL_STRING', "Truque: "..tricks[index][2])
