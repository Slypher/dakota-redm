...
function load(interiorId)
    local weapons = {
        ...
        --{"PISTOL_MAUSER", 30000, 1400, 1, "w_pistol_mauser01"},
        ...
        --{"SHOTGUN_DOUBLEBARREL", 6500, 1500, 1, "w_shotgun_doublebarrel01"},

        -- SNIPER RIFLE
        --------{"sniperrifle_rollingblock", 14000, 70, 1, "w_rifle_rollingblock01"},

        -- ARMAS BRANCAS
        --{"thrown_throwing_knives", 250, 50, 1, "w_melee_tomahawk03"},
        --{"melee_cleaver", 8, 1, 1, "p_cleaver01x"},
        {"kit_binoculars", 1000, 1, 1, "w_binoculars01x"},
    ...
    local ammos = {
        {"ammo_revolver", 300, 1, 20, "s_inv_revolverammo01x"},
        {"ammo_pistol", 300, 1, 20, "s_inv_pistolammo01x"},
        {"ammo_repeater", 300, 1, 20, "s_inv_repeat_rifleammo01x"},
        {"ammo_rifle", 400, 1, 20, "s_inv_rifleammo01x"},
        {"ammo_22", 300, 1, 20, "s_inv_varmint_rifleammo01x"},
        {"ammo_shotgun", 400, 1, 20, "s_inv_shotgunammo01x"},
    }
...
function createPrompt(name, itemId, dollar, gold, entitytarget)
    ...
    PromptSetControlAction(prompt_dollar, 0xE30CD707) --0x07CE1E61) -- LMB
    ...
    PromptSetControlAction(prompt_gold, 0x8AAA0AD4) --0xF84FA74F) -- RMB
