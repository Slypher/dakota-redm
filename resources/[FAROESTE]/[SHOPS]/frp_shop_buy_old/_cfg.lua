...
Config.ShopDatas = {
	...
	},
	{
		name = "Armeiro",
		{
			{"canodearma", 1, 3000, 1200},
			{"caodearma", 1, 2000, 800},
			{"gatilhodearma", 1, 100, 1},
			{"corpodearma", 1, 100, 1},
		}
	},
	{
		name = "Loja de Sementes",
		{
			{"tobaccoseed", 1, 5, 1},
			{"cornseed", 1, 6, 1},
			{"cenouraseed", 1, 5, 1},
...
Config.ShopLocations = {
	...
	["Armeiro"] = {
		{-277.221,778.932,119.504}
	},
	["Loja de Sementes"] = {
		{-323.531,799.175,117.882}
	},

	["Loja Sallon"] = {
		{-311.647,806.275,118.980}
	},

	["Mercado Geral"] = {
		{1327.907, -1292.865, 77.023},
		{-785.338, -1323.850, 43.884},
		{-322.371,804.258,117.882}
	}
}
