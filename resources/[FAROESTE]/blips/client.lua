...
local blips = {
	...
	--BARBERO
	{ name = 'Barbero', sprite = -2090472724, x = -307.167, y = 811.311, z = 118.980 }, -- valentine
	--SALOON
	...
	--EMPREITERA
	{name = "Empreiteira", sprite = -426139257, x = -355.94, y = 810.54, z = 116.22}, --	-355.947,810.545,116.224
