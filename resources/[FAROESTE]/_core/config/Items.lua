ItemList = {
    ...
    ["melee_davy_lantern"] = { -- TESTE DAVY
        ...
        name = "Lampião",
        weight = 1.0,
        description = "Um pequeno lampião capaz iluminar muito bem no escuro.",
        stackSize = 1,
        worldModel = "s_interact_lantern03x_pickup"
    },
    ...
    ["pistol_semiauto"] = {
        ...
        stackSize = 1,
        worldModel = "w_pistol_semiauto01"
    },
    ["pistol_volcanic"] = {
        type = "weapon",
    ...
    ['revolver_navy'] = {
        ...
        weight = 1.2,
        description = 'Este revólver foi usado por muitas pistoleiros famosos como...',
        stackSize = 1,
        worldModel = "w_revolver_navy01"
    },
    ["revolver_schofield"] = {
        type = "weapon",
        name = "Revolver Schofield",
        weight = 1.32,
        description = "O Schofield é um revólver com seis disparos, útil em combate a curta distância, basta descobrir o quão curta ela é...",
        stackSize = 1,
        worldModel = "w_revolver_schofield01"
    },
    ...
    ["rifle_boltaction"] = {
        ...
        stackSize = 1,
        worldModel = "w_rifle_boltaction01"
    },
    ["sniperrifle_carcano"] = {
        type = "weapon",
        name = "Rifle Carcano",
    ...
    ["shotgun_doublebarrel"] = {
        ...
        name = "Escopeta de Cano duplo",
        weight = 3.4,
        description = "Esta arma é capaz de matar um urso com um único disparo, imagina o que ela pode fazer com um maldito infeliz.",
        stackSize = 1,
        worldModel = "w_shotgun_doublebarrel01"
    },
    ["shotgun_double_pump"] = {
        type = "weapon",
...
-- COMIDA
    ...
    ['pao'] = {
        ...
        weight = 0.1,
        varOnUse = 1.0,
        description = 'O pão que o Quintero amassou.',
        stackSize = 5,
    },
    ["feijaolata"] = {
        type = "edible",
        ...
        weight = 0.09,
        varOnUse = 0.4,
        description = "Uma lata cheia de feijões, da pra matar um pouquinho a fome...",
        stackSize = 5
    },
    ["milholata"] = {
        type = "edible",
    ...
    ["bolacha"] = {
        ...
        weight = 0.05,
        varOnUse = 0.7,
        description = "Vai uma bolachina ai? Coisa boa viu!",
        stackSize = 5
    },
    ["biscoito"] = {
        type = "edible",
        ...
        weight = 0.1,
        varOnUse = 0.7,
        description = "Vai uma biscoitinho ai? Coisa boa viu!",
        stackSize = 5
    },
    ["carneruimassada"] = {
        type = "edible",
        name = "Carne Assada de Má Qualidade",
        weight = 0.2,
        description = "Uns pedaços de carne assada.",
        stackSize = 5
    },
    ["carneboaassada"] = {
        type = "edible",
        name = "Carne Assada de Boa Qualidade",
        weight = 0.3,
        description = "Muito boa... Hmmm, é, muito boa...",
        stackSize = 3
    },
    ["carneprimeiraassada"] = {
        type = "edible",
        name = "Carne de Primeira Assada",
        weight = 0.4,
        description = "Uma das melhores refeições que você pode fazer.",
        stackSize = 3
    },
    ["peixegrandeassado"] = {
        type = "edible",
        name = "Peixe Grande Assado",
        weight = 2.0,
        description = "Uma excelente refeixão, se comparado com muitas outras coisas.",
        stackSize = 3
    },
    ["peixemedioassado"] = {
        type = "edible",
        name = "Peixe Médio Assado",
        weight = 1.0,
        description = "Tem muitos nutrientes, mas tem muitos espinhos também.",
        stackSize = 3
    },
    ["peixepequenoassado"] = {
        type = "edible",
        ...
        weight = 0.5,
        description = "Quase não mata a fome, mas tem seus nutrientes.",
        stackSize = 3
    },
    ["carneavefrita"] = {
        type = "edible",
        name = "Carne de Ave Frita",
        weight = 0.3,
        description = "Um pedaço de carne  de ave frito na gordura de animais.",
        stackSize = 3
    },
    ["carnefrita"] = {
        type = "edible",
        name = "Carne Frita",
        weight = 0.3,
        description = "Um pedaço de carne frito na gordura de animais.",
        stackSize = 3
    },
    ["sopa"] = {
        type = "edible",
    ...
    ["molhotomate"] = {
        ...
        weight = 0.3,
        description = "E esse pedaço de tomate se mexendo aqui dentro?",
        stackSize = 10
    },
    ...
    ["cerveja"] = { --COLOCAR EFEITO DE BEBADO/ANIMAÇÃO
        type = "beverage",
        name = "Cerveja",
        weight = 0.430,
        varOnUse = 1.0,
    ...
    ["whisky"] = { --COLOCAR EFEITO DE BEBADO/ANIMAÇÃO
        type = "beverage",
        name = "Uísque",
        weight = 0.8,
        varOnUse = 1.0,
    ...
    ["cafe"] = {
        ...
        weight = 0.23,
        varOnUse = 1.0,
        description = "Excelente para se manter acordado.",
        stackSize = 3
    },
    ["vitamina"] = {
        type = "beverage",
        ...
        weight = 0.25,
        varOnUse = 1.0,
        description = "Quase como uma comida.",
        stackSize = 3
    },
    ["sucolaranja"] = {
        type = "beverage",
        ...
        weight = 0.25,
        varOnUse = 1.0,
        description = "Um suco de fruta muito saboroso.",
        stackSize = 3
    },
...
-------------------------------------------------------------------------------------------------------------
    ...
    ["tirascouro"] = {
        ...
        name = "Tiras de Couro",
        weight = 0.02,
        description = "Pedaços de couro usados para amarrar coisas.",
        stackSize = 50
    },
    ["osso"] = {
        type = "generic",
    ...
    ["oleodepeixe"] = {
        ...
        name = "Óleo de Peixe",
        weight = 0.2,
        description = "Faz muito bem para a memória.",
        stackSize = 20
    },
    ["venenodecobra"] = {
        type = "generic",
    ...
    ["rabocastor"] = {
        type = "generic",
        name = "Cauda de Castor",
        weight = 0.2,
        description = "Ajuda a dar um impulso.",
        stackSize = 10
    },    
    ["galhadagrande"] = {
        type = "generic",
    ...
    ["glandulas"] = {
        type = "generic",
        name = "Glândulas odoriferas",
        weight = 0.05,
        description = "Disfarça o cheiro, caçadores costumam usar isso.",
        stackSize = 10
    },    
    ["caudaesquilo"] = {
        type = "generic",
        name = "Cauda de Esquilo",
        weight = 0.1,
        description = "Dizem por ai que da sorte.",
        stackSize = 10
    },    
    ["dentejavalilendario"] = {
        type = "generic",
    ...
    ["peledecobra"] = {
        ...
        name = "Pele de Cobra",
        weight = 0.1,
        description = "Será que já estava na hora de trocar de pele?",
        stackSize = 10
    },       
    ["pigeonpost"] = {
        type = "document",
    ...
    ["repolho"] = {
        ...
        name = "Repolho",
        weight = 0.5,
        description = "Um monte de folhas formando um... Repolho!",
        stackSize = 10
    },
    ["papola"] = {
        type = "generic",
    ...
    ["lupulo"] = {
        ...
        name = "Lúpulo",
        weight = 0.5,
        description = "Material útil para produção de cerveja.",
        stackSize = 45
    },
    ["pocafe"] = {
        type = "generic",
    ...
    ["caodearma"] = {
        ...
        name = "Cão de Arma",
        weight = 0.02,
        description = "O cão é responsável por acender o propelente e disparar o projétil.",
        stackSize = 24
    },
    ["gatilhodearma"] = {
        type = "kit",
        ...
        weight = 0.02,
        description = "Libera o Cão para que ele Acenda o Propelente e efetue o disparo.",
        stackSize = 24
    },
    ["caixacartuchos"] = {
        type = "kit",
...
-----------------------------------------------------------------------------------------------------------------------
    ...
    ["corda"] = {
        ...
        name = "Corda",
        weight = 0.1,
        description = "São feitas através de fibras vegetais.",
        stackSize = 10
    },
    ["estruturasimples"] = {
        type = "generic",
        name = "Estrutura de Arco",
        weight = 0.3,
        description = "A estrutura de um arco simples, só falta a corda",
        stackSize = 3
    },
    ["estruturacurvada"] = {
        type = "generic",
        name = "Estrutura de Arco Curvado",
        weight = 0.5,
        description = "A estrutura de um arco curvado, só falta a corda",
        stackSize = 3
    },
    ["pontadeflecha"] = {
        type = "generic",
    ...
    ["raizesdaterra"] = { --COLOCAR EFEITO DE BEBADO/ANIMAÇÃO
        type = "edible",
        name = "Erva de Raízes da Terra",
        weight = 0.25,
        description = "Uma mistura de raízes... ",
        stackSize = 3
    },
    ["olhosdeaguia"] = { -- ATIVAR OS OLHOS DE ÁGUIA POR UM PERIODO DE TEMPO
        type = "edible",
        name = "Erva dos Olhos de Águia",
        weight = 0.3,
        description = "A visão de uma águia, o faro de um lobo, e o tato de um homem...",
        stackSize = 3
    },
    ...
    ["ervamedicinal"] = { -- REVIVE E CURA
        ...
        name = "Erva Medicinal",
        weight = 0.3,
        description = "Uma mistura de ervas que, segundo a lenda pode reviver até um urso.",
        stackSize = 3
    },
...
----------------------------- PLANTAS E OVOS -------------------------------
    ...
    ["oregano"] = {
        ...
        name = "Orégano",
        weight = 0.6,
        description = "Uma erva perena, normalmente utilizado como tempero.",
        stackSize = 10
    },
    ["tomilhorastejante"] = {
        type = "generic",
        name = "Tomilho Rastejante",
        weight = 0.6,
        description = "É utilizado normalmente para fins codimentares, como tempero. Ajuda a manter o fôlego por mais tempo.",
        stackSize = 10
    },
    ["ginsengamericano"] = {
        type = "generic",
