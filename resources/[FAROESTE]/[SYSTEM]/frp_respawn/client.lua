...
RegisterNetEvent("FRP:RESPAWN:Treatment2")
AddEventHandler(
	"FRP:RESPAWN:Treatment2",
	function()
		cAPI.VaryPlayerHealth(5, 5)
		Citizen.InvokeNative(0xC6258F41D86676E0, PlayerPedId(), 0, 100)
		DestroyAllCams(true)
...
local Locations = {
	...
	[2] = vector3(-282.606,815.140,119.386), -- VALENTINE
	[3] = vector3(-282.606,815.140,119.386), -- VALENTINE
...
function InitiateGetUpPrompt()
	...
	PromptSetText(prompt_getup, CreateVarString(10, "LITERAL_STRING", "Acordar"))
