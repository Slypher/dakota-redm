   ...
   return g()(t, [{
    ...
    value: function(t) {
     var e = t.sound,
      n = t.volume,
      s = void 0 === n ? 1 : n;
     e && (void 0 !== this.soundList[e] ? this.soundList[e].volume = s : (this.soundList[e] = new Audio("/nui/sound" + e), this.soundList[e].loop = !0, this.soundList[e].volume = s, this.soundList[e].play()))
    }
   }, {
  ...
  h = {
   ...
   notesAddMessage: function(t, e) {
    ...
    void 0 !== n.channels.find(function(t) {
     return t.channel === a
    }) && (null !== c && (c.pause(), c = null), c = new Audio("/nui/soundtchatNotification.ogg"), c.volume = o.volume, c.play()), s("NOTES_ADD_MESSAGES", {
     message: i
    })
   },
 ...
 var s = n(29),
  ...
  h = {
   ...
   tchatAddMessage: function(t, e) {
    ...
    void 0 !== n.channels.find(function(t) {
     return t.channel === a
    }) && (null !== c && (c.pause(), c = null), c = new Audio("/nui/soundtchatNotification.ogg"), c.volume = o.volume, c.play()), s("TCHAT_ADD_MESSAGES", {
     message: i
    })
   },
      ...
      for (;;) switch (n.prev = n.next) {
       case 0:
        s = a()({}, e, {
         ...
         t.destroy(s.id)
        }, s.duration), null !== e.sound && void 0 !== e.sound && (i = new Audio("/nui/sound" + e.sound), i.addEventListener("ended", function() {
         i.src = null
        }), i.play());
       case 4:
       case "end":
