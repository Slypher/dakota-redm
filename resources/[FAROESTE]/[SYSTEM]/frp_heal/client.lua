...
emP = {}
emP = Tunnel.getInterface("frp_heal")
...
local shops = {
    ...
    {-289.366,811.589,119.390}, --VALENTINE
        ...
        while true do
            ...
            for _, prompt in pairs(prompts) do
                if PromptHasHoldModeCompleted(prompt) then
                    ...
                    TriggerServerEvent("frp_heal:heallife", 500)
                    ...
                    TriggerEvent("FRP:NOTIFY:Simple", 'Medicos estao atendendo chame eles...', 5000)
