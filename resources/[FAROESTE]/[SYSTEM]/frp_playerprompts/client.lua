    ...
    function()
        ...
        while true do
            ...
            if targetedNonPlayerEntity ~= nil or targetedPlayerEntity ~= nil then
                ...
                DisableControlAction(0, 0xF8982F00, false)
                ...
                if isAPlayer then
                    ...
                    PromptSetVisible(prompt_enviar, true)

                    if isAlive then
                        if distance <= 1.5 then
                            PromptSetEnabled(prompt_enviar, true)
                        ...
                        if distance > 2.5 then
                            ...
                            PromptSetEnabled(prompt_enviar, false)
                ...
                if PromptHasHoldModeCompleted(prompt_enviar) then
                    quickPromptEnabledToggle(prompt_enviar)
                    Wait(300)
                    TriggerServerEvent("FRP:SHERIFF:enviar", targetedPlayerServerId)
                end
