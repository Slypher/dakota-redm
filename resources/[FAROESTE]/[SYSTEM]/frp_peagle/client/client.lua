            ...
            Citizen.Wait(1)
                ...
                if dst < 25 then  
                    if not Notified then
                        TriggerEvent('FRP:NOTIFY:Simple', 'Um pombo correio esta a caminho, espere o pombo chegar e pegue a carta.', 5000)
                        Notified = true 
                        back = false                   
                    end
...
RegisterNUICallback('escape', function(data, cb)
    TriggerEvent("FRP:PEAGLE:CloseNotepad")
end)

RegisterNetEvent("FRP:PEAGLE:CloseNotepad")
AddEventHandler("FRP:PEAGLE:CloseNotepad", function()
