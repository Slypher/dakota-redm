Citizen.CreateThread(function()
    ...
    while true do
        ...
        if WarMenu.IsMenuOpened('pedmenu') then
			...
			if WarMenu.MenuButton('Homens', 'MenuMale') then 
            end
			
			if WarMenu.MenuButton('Mulheres', 'MenuFemale') then
            end
			
			if WarMenu.MenuButton('Adolescentes', 'MenuKid') then
            end
			
			if WarMenu.MenuButton('Cachorros', 'MenuDog') then
            end
			
			if WarMenu.MenuButton('Cavalos', 'MenuHorse') then
            end
			
			--if WarMenu.MenuButton('UnderWater Animals', 'MenuAnimalWater') then -- Removing skin make player around to crash
            --end
			
			if WarMenu.MenuButton('Animais', 'MenuAnimalGround') then
            end
			
			if WarMenu.MenuButton('Pássaros', 'MenuAnimalFly') then
            end
			
			if WarMenu.MenuButton('Animações', 'MenuPedAnim') then
            end
			
			if WarMenu.MenuButton('Remover Skin', 'MenuRemoveSkin') then
            end
