...
Config.Pickaxe = "melee_hatchet" -- Item from your database that you want to use for a pickaxe
Config.MinGoldChance = 1 -- Minimum Gold Chance
Config.MaxGoldChance = 100 -- Maximum Gold Chance

Config.GoldChance = 5 -- 5% chance to find a goldnugget (make sure is between MinGoldChance and MaxGoldChance)
