TokoVoipConfig = {
	...
	distance = {
		6, -- Normal speech distance in gta distance units
		3, -- Whisper speech distance in gta distance units
		1000, -- Shout speech distance in gta distance units
	},
	...
	radioKey = 0, -- Keybind used to talk on the radio
	keySwitchChannels = 0, -- Keybind used to switch the radio channels
	keySwitchChannelsSecondary = 0, -- If set, both the keySwitchChannels and keySwitchChannelsSecondary keybinds must be pressed to switch the radio channels
	keyProximity = 0x064D1698, -- Keybind used to switch the proximity mode
	...
	plugin_data = {
		...
		TSServer = "ts3.serverbb.net:9088", -- TeamSpeak server address to be displayed on blocking screen
